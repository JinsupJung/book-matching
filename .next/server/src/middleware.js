...
// src/analytics.ts
var import_core_analytics = __webpack_require__(202);
var Analytics = class {
  analytics;
  table = "events";
  constructor(config) {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_ts_page_2Fsrc_2Fmiddleware_rootDir_2FUsers_2Fjinsup_2FDesktop_2FCoding_2FReact_2Fmax_2F_section_2023_20nextjs_2Fchatbot_youtube_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL21lc3NhZ2UoPzpcXC8oKD86W15cXC8jXFw_2FXSs_2FKSg_2FOlxcLyg_2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik_2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9hcGkvbWVzc2FnZS86cGF0aCoifV0_3D_)
});
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=%2FUsers%2Fjinsup%2FDesktop%2FCoding%2FReact%2Fmax%2F(section%2023)%20nextjs%2Fchatbot-youtube&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL21lc3NhZ2UoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9hcGkvbWVzc2FnZS86cGF0aCoifV0%3D!

        

        enhanceGlobals()

        var mod = __webpack_require__(268)
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fsrc_2Fmiddleware_ts_page_2Fsrc_2Fmiddleware_rootDir_2FUsers_2Fjinsup_2FDesktop_2FCoding_2FReact_2Fmax_2F_section_2023_20nextjs_2Fchatbot_youtube_matchers_W3sicmVnZXhwIjoiXig_2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpP1xcL2FwaVxcL21lc3NhZ2UoPzpcXC8oKD86W15cXC8jXFw_2FXSs_2FKSg_2FOlxcLyg_2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik_2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9hcGkvbWVzc2FnZS86cGF0aCoifV0_3D_(opts) {
          return adapter({
              ...opts,
              page: "/src/middleware",
              handler,
...
class HRandFieldCommand extends Command {
    constructor(cmd, opts) {
        ...
        super(command, {
            // @ts-ignore TODO:
            deserialize: cmd[2]
                ? (result) => hrandfield_deserialize(result)
                : opts?.deserialize,
            ...opts,
        });
    }
...
;// CONCATENATED MODULE: ./src/lib/redis.ts
...
var dist = __webpack_require__(537);
;// CONCATENATED MODULE: ./src/lib/rate-limiter.ts


// Create a new ratelimiter, that allows 10 requests per 10 seconds
const rateLimiter = new dist.Ratelimit({
    redis: redis,
    limiter: dist.Ratelimit.slidingWindow(4, "10 s"),
    /**
...
async function middleware(req) {
    ...
    try {
        ...
        if (!success) return new next_response/* default */.Z("타이핑 속도가 처리하기에 너무 빠릅니다.");
        return next_response/* default.next */.Z.next();
    } catch (error) {
        return new next_response/* default */.Z("Sorry, something went wrong processing your message. Please try again later.");
    }
}
